...
export class News extends Component {
  ...
  render() {
    return (
        ...
        <NewsItem title = "Hey" description = "Number 1 News item cool" imageURL="https://commondatastorage.googleapis.com/codeskulptor-assets/lathrop/nebula_blue.s2014.png" />
        
        </div>
        <div className='col-md-4'> 
        <NewsItem title = "Hey" description = "Number 1 News item cool" />
        </div>
